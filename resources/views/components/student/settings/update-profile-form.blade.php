                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="age" name="age" type="number" class="form-control"
                                   value="{{ old('age', auth()->user()->studentProfile?->age) }}" required>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input id="native_language" name="native_language" type="text" class="form-control"
                                   value="{{ old('native_language', auth()->user()->studentProfile?->native_language) }}" required>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <select id="english_level" name="english_level" class="form-control" required>
                                <option value="" disabled {{ old('english_level', auth()->user()->studentProfile?->english_level) ? '' : 'selected' }}>Please select your level</option>
                                @php
