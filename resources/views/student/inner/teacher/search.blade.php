            ...
            <div class="bg-primary-gradient rounded-pill doctors-search-box">
                <div class="search-box-one rounded-pill">
                    <form method="GET" action="{{ route('student.tutors.search') }}" id="searchForm">
                        ...
                        <input type="hidden" name="japanese_level" id="hiddenJapaneseLevel" value="{{ request('japanese_level') }}">
                ...
                <div class="col-xl-3">
                    <div class="card filter-lists">
                        ...
                        <div class="card-body p-0">
                            <!-- Native Language -->
                            {{-- @include('student.inner.teacher.partials.native-language') --}}
                            {{-- japanese level filter --}}
                            @include('student.inner.teacher.partials.japanese-level-filter')
                            {{--  --}}
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.japanese-level-filter', function() {
                var selectedLevel = $(this).val();

                // TARGET THE EXISTING HIDDEN INPUT BY ID
                $('#hiddenJapaneseLevel').val(selectedLevel);
