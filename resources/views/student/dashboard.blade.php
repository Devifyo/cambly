                ...
                <div class="dashboard-card w-100">
                    ...
                    <div class="dashboard-card-body">
                        <div class="row">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="patient-info-profile">
                                                            <a href="#" class="table-avatar">
                                                                <img src="{{ asset('assets/img/tutors/tutor-01.jpg') }}"
                                                                    alt="Tutor">
                                                            </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="patient-info-profile">
                                                            <a href="#" class="table-avatar">
                                                                <img src="{{ asset('assets/img/tutors/tutor-02.jpg') }}"
                                                                    alt="Tutor">
                                                            </a>
                                                            <div class="patient-name-info">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="patient-info-profile">
                                                            <a href="#" class="table-avatar">
                                                                <img src="{{ asset('assets/img/tutors/tutor-03.jpg') }}"
                                                                    alt="Tutor">
                                                            </a>
                                                            <div class="patient-name-info">
                                                                <h5><a href="#">Dr. Brown</a></h5>
                                                                <span>Physics</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="appointment-date-created">
                                                            <h6>28 Oct 2025 - 4:30 PM</h6>
                                                            <span class="badge table-badge bg-secondary">Planned</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="apponiment-actions d-flex align-items-center">
                            ...
                            <div class="col-sm-5">
                                <div class="chart-over-all-report text-center">
                                    ...
                                    <span class="health-percentage d-block mb-2">You have enough credits for 3 more
                                        sessions</span>
                        ...
                        <div class="report-gen-date mt-4">
                            <p>Subscription valid till: <strong>31 Dec 2025</strong> <span><i
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [{
                    ...
                    {
                        title: 'English - Ms. Johnson',
                        start: new Date(Date.now() + 86400000).toISOString().split('T')[0] + 'T14:00:00'
                    }, // Future
                    {
                        title: 'Physics - Dr. Brown',
                        start: '2025-10-20T11:00:00'
                    }, // Past
                    {
                        title: 'Chemistry - Ms. Davis',
                        start: '2025-10-27T16:00:00'
                    } // Future
                ],

                // Dynamically apply event color
                eventDidMount: function(info) {
                    const eventDate = new Date(info.event.start);
                    let className = '';

                    if (eventDate.toDateString() === today.toDateString()) {
                        className = 'event-today'; // today's session
                    } else if (eventDate < today) {
                        className = 'event-past'; // older
                    } else {
                        className = 'event-upcoming'; // upcoming
                    }
